...
class PopulationModel:
    def __init__(self, country):
        ...
        self.model_filename = f"{country.replace(' ', '_').lower()}_population_model.pkl"
        self.model = None
...
class PopulationForecaster:
    ...
    def run(self):
        ...
        try:
            country = input("\nEnter the name of the country to forecast population: ").strip()
        ...
        future_years = pd.DataFrame({"year": [last_year + 10 * i for i in range(1, self.forecast_horizon + 1)]})
...
if __name__ == "__main__":
    csv_path = r"C:\Users\Vince\Downloads\AI_world_population.csv"
